...
path="/home/k/PycharmProjects/pythonProject/kerasOCR/masterCard/Alyn/deskew/tests/5/CV (2).jpg5.png"
# Load file, converting to grayscale

I = asarray(Image.open(path).convert('L'))
#I = asarray(Image.open(dirPath+filename[0]).convert('L'))
...
r = array([line for line in sinogram.transpose()])
rotation = argmax(r)
