...
class SkewDetect:
    ...
    def process_single_file(self):
        ...
        if self.output_file:
            ...
            try:
                ...
                print("\n\t\t Estimated Angle:",res['Estimated Angle'])
                print("\n\t\t 'Angle bins':",res['Angle bins'])
                pass
    ...
    def determine_skew(self, img_file):
        ...
        #img = io.imread(img_file, as_grey=False)

        #print("\n\t is file",os.path.isfile(img_file))
        ...
        edges = canny(img, sigma=3) #canny(img, sigma=3)
...
if __name__ == '__main__':
    ...
    input_file="./examples/2.jpg"
    output_file="./examples/out/"
    print("\n\t options.input_file:",input_file)
    print("\n\t options.output_file:",output_file)
    skew_obj = SkewDetect(
        input_file,None,output_file,None,None,None,None)
    skew_obj.run()
